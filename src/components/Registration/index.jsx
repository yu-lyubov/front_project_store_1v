...
class Registration extends React.Component {
    ...
    onSaveData() {
        ...
        if (
            ...
            passwordMatch(user.password, user.password2)
        ) {
        ...
        return alert('Введены неверные значения!');
    }
                ...
                <div className="innerRegistrationBlock border rounded-3 p-5 bg-white">
                    ...
                    <input
                        ...
                        className={`form-control mb-3 ${
                            login && login.length > 1 ? 'border-success' : ''
                        }`}
                    ...
                    <input
                        ...
                        className={`form-control mb-3 ${email ? 'border-success' : ''} ${
                            validateEmail(email) ? '' : 'border-danger'
                        }`}
                    ...
                    <input
                        ...
                        className={`form-control mb-3 ${
                            password && password.length > 5 ? 'border-success' : ''
                        }`}
                    ...
                    <input
                        ...
                        className={`form-control mb-3 ${
                            password && password2 ? 'border-success' : ''
                        } ${passwordMatch(password, password2) ? '' : 'border-danger'}`}
