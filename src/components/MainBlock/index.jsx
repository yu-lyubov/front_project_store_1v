                ...
                <div className="innerMainBlockBlock border rounded-3">
                    <div className="pb-2 border-bottom">
                        ...
                        <div className="input-group mb-3 w-100">
                            <input
                                value={selectedHome.homeName || ''}
                                onChange={this.onChangeHomeName}
                                className={`form-control ${
                                    selectedHome.homeName.length < 1 ? 'border-danger' : ''
                                }`}
                            ...
                            <div className="input-group-append">
                                <button
                                    ...
                                    className={`btn btn-outline-secondary bg-success text-white ${
                                        selectedHome.homeName.length < 1 ? 'disabled' : ''
                                    }`}
                                >
                                    Save
                                </button>
                    ...
                    <div>
                        ...
                        <div className="input-group mb-3 w-100">
                            <input
                                ...
                                className={`form-control ${
                                    selectedRoom.roomName.length < 1 ? 'border-danger' : ''
                                }`}
                                placeholder="HouseNames"
                            />
                            <div className="input-group-append">
                                <button
                                    ...
                                    className={`btn btn-outline-secondary bg-success text-white ${
                                        selectedRoom.roomName.length < 1 ? 'disabled' : ''
                                    }`}
                                >
                                    Save
                                </button>
